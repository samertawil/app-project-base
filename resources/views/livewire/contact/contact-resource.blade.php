                                ...
                                @foreach ($contacts as $contactList)
                                    <div class="main-contact-item selected">
                                        ...
                                        <div class="main-contact-body">
                                            <h6>{{ $contactList->full_name }}</h6><span
                                                class="phone">{{ $contactList->personal_phone_primary }}</span>
                                        </div>
                    ...
                    <div class="main-content-body main-content-body-contacts card custom-card">
                        <div class="main-contact-info-header pt-3">
                            <div class="media">
                                ...
                                <div class="media-body mr-2 ">
                                    ...
                                    @else
                                        <x-input class="custom-border text-primary mb-1 " divWidth="8"
                                            marginBottom="1" value="{{ $contactObject->full_name }}"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @else
                                            <x-input class="custom-border   mb-1 " divWidth="8"
                                                value="{{ $contactObject->short_description }}"></x-input>
                                        @endif
                        ...
                        <div>
                            ...
                            <div class="row mt-3 justify-content-start align-items-center">
                                ...
                                @else
                                    <x-input class="custom-border "
                                        value="{{ $contactObject->contactTypeName->status_name }}"
                                        divWidth="3"></x-input>
                                @endif
                                ...
                                @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                                    <x-input class="custom-border " value="{{ $contactObject->fname }}"
                                        divWidth="2"></x-input>
                                @endif
                                ...
                                @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                                    <x-input class="custom-border " value="{{ $contactObject->sname }}"
                                        divWidth="2"></x-input>
                                @endif
                                ...
                                @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                                    <x-input class="custom-border " value="{{ $contactObject->tname }}"
                                        divWidth="2"></x-input>
                                @endif
                                ...
                                @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                                    <x-input class="custom-border " value="{{ $contactObject->lname }}"
                                        divWidth="2"></x-input>
                                @endif
                                ...
                                @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                                    <x-input class="custom-border "
                                        value="{{ $contactObject->nick_name }}"></x-input>
                                @endif
                                ...
                                @elseif ($editContact !== $contactObject->id && in_array($ContactTypeToshow, ['1237', '1238', '1239']))
                                    <x-input class="custom-border "
                                        value="{{ $contactObject->responsible }}"></x-input>
                                @endif
                                ...
                                @else
                                    <x-input class="custom-border "
                                        value="{{ $contactObject->identity_number }}"></x-input>
                                @endif
                            ...
                            <div class="media-list pb-0">
                                <div class="media">
                                    <div class="media-body">
                                        <div>
                                            @if ($editContact === $contactObject->id)
                                                <x-input wire:model='personal_phone_primary'
                                                    name="personal_phone_primary" divWidth="6" label
                                                    class="custom-border mt-0 pt-0" labelclass="pb-0"></x-input>
                                            @else
                                                <x-input class="custom-border  mt-0 pt-0" divWidth="6"
                                                    labelclass="pb-0" label name="personal_phone_primary"
                                                    value="{{ $contactObject->personal_phone_primary }}"></x-input>
                                            @endif
                                        ...
                                        <div>
                                            ...
                                            @else
                                                <x-input class="custom-border  mt-0 pt-0" divWidth="6"
                                                    labelclass="pb-0" label name="personal_phone_secondary"
                                                    value="{{ $contactObject->personal_phone_secondary }}"></x-input>
                                            @endif
                                ...
                                <div class="">
                                    <div class="media-body">
                                        <div>
                                            ...
                                            @else
                                                <x-input class="custom-border  mt-0 pt-0" divWidth="6"
                                                    labelclass="pb-0" label name="work_phone_primary"
                                                    value="{{ $contactObject->work_phone_primary }}"></x-input>
                                            @endif
                                        </div>
                                        <div>
                                            @if ($editContact === $contactObject->id)
                                            ...
                                            @else
                                                <x-input class="custom-border  mt-0 pt-0" divWidth="6"
                                                    labelclass="pb-0" label name="work_phone_secondary"
                                                    value="{{ $contactObject->work_phone_secondary }}"></x-input>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-50 mb-3">
                                    ...
                                    @foreach ($contactObject->properties as $key => $prop)
                                        <li class="custom-border p-x pt-3"> {{ $prop }}     :  <span class="text-muted">{{ $key }}</span></li>
                                    @endforeach
