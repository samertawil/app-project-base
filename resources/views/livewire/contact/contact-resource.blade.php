                     ...
                     <div class="row mt-3 justify-content-start align-items-center">
                         ...
                         @if ($editContact === $contactObject->id && $ContactTypeToshow == 1236)
                             <x-input wire:model='fname' name="fname" divWidth="2"
                                 class="custom-border-bottom-dotted" placeholder="{{ __('mytrans.fname') }}"></x-input>
                         ...
                         @if ($editContact === $contactObject->id && $ContactTypeToshow === 1236)
                             <x-input wire:model='sname' name="sname" divWidth="2"
                                 class="custom-border-bottom-dotted" placeholder="{{ __('mytrans.sname') }}"></x-input>
                         @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                         ...
                         @if ($editContact === $contactObject->id && $ContactTypeToshow === 1236)
                             <x-input wire:model='tname' name="tname" divWidth="2"
                                 class="custom-border-bottom-dotted" placeholder="{{ __('mytrans.tname') }}"></x-input>
                         @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                         ...
                         @if ($editContact === $contactObject->id && $ContactTypeToshow === 1236)
                             <x-input wire:model='lname' name="lname" divWidth="2"
                                 class="custom-border-bottom-dotted" placeholder="{{ __('mytrans.lname') }}"></x-input>
                         @elseif($editContact !== $contactObject->id && $ContactTypeToshow == 1236)
                         ...
                         <div class="media">
                             <div class="media-body">
                                 <div>
                                     ...
                                     @else
                                         <x-input class="custom-border-bottom-dotted  mt-0 pt-0 bg-white"
                                             divWidth="6" labelclass="pb-0" label name="personal_phone_primary"
                                             value="{{ $contactObject->personal_phone_primary }}" disabled></x-input>
                                     @endif
                                 ...
                                 <div>
                                     ...
                                     @else
                                         <x-input class="custom-border-bottom-dotted  mt-0 pt-0 bg-white"
                                             divWidth="6" labelclass="pb-0" label name="personal_phone_secondary"
                                             value="{{ $contactObject->personal_phone_secondary }}"
                                             disabled></x-input>
                                     @endif
