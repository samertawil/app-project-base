...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div class="d-flex">
            <p class="mt-2 text-sm text-center text-gray-600 leading-5 max-w">{{ __('auth.New Here') }}</p>
            ...
            <form wire:submit.prevent="authenticate">
                <div>
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="email" id="email" name="email" type="email" required autofocus dir="rtl"
                ...
                <x-input name="user_name" wire:model="user_name" label="yes" required autofocus dir="rtl" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
