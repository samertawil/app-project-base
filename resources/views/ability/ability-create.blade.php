...
<x-slot:crumb>
    ...
    <x-breadcrumb CurrentPageTitle="عرض المستخدمين"    :route="route('user.create')" wire:navigate
...
<form wire:submit='storeAbility'>
    <div class="row">
        ...
        <x-input type="text" name="ability_description" label='yes' req
            description_field="مثال: انشاء مستخدم" wire:model="ability_description"></x-input>
