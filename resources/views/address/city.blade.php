...
<x-search-index-section>
    ...
    <x-select :options="$regions->pluck('region_name', 'region_id')" name="region_id" wire:model.live="regionIdSearch" ></x-select>
                 ...
                 <tbody>
                     ...
                     @foreach ($cities as $key => $city)
                         <tr >
                             ...
                             <td>
                                <x-select :options="$regions->pluck('region_name', 'region_id')" name="region_id" wire:model="regionIdUpdate"   divWidth='10'></x-select>  </td>
